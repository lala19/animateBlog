...
router.post('/', function (req, res, next) {
  ...
  writerStream.end('finish', function () {
    ...
    createConnection(`UPDATE essayinfo SET e_title='${req.body.e_title}',e_describe='${req.body.e_describe}',e_content='${strTXT}' where e_id=${req.body.e_id}`, function (results) {
      var obj = {
        status: 1,
        msg: "修改成功"
      }
